...
*Fordi ingen av verdiene til oppservasjonene er så tett at de vil bli slått sammen hvis man slår sammen de verdiene som er 0.1 unna.*
...
df_ny <- df_ny [!(df_ny$ssgruppe == "10-19" | df_ny$ssgruppe == "10-49"),]
...
df1 <- df1 [!(df1$ssgruppe == "10-19" | df1$ssgruppe == "10-49"),]
